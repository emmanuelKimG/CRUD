...
<body>
    ...
    <div class="flex-container text-center align-items-center ">
        <form action="http://localhost/CrudSimple/?id=<?php echo ($id); ?>" method="POST">
            ...
            <label for="nombre">Lenguaje</label><input type="text" name="Mlengua" value="<?php  echo $_GET['name']?>">
            <label for="lenguaje">Pais</label><input type="text" name="Mpais" value ="<?php echo $_GET['id'] ?>">
